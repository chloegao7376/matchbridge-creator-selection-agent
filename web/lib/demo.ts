...
export const demoBriefs: CampaignBrief[] = [
  {
    ...
    target_regions: ['全国', '一二线城市优先'],
    target_audience: {
      gender_preference: 'balanced',
      primary_age_band: '25_34',
      interest_tags: ['健康饮食', '高蛋白', '轻食早餐'],
    },
    tone_tags: ['专业可信', '清晰易懂', '真实体验'],
    required_topics: ['配料表解读', '早餐场景', '营养搭配'],
    forbidden_topics: ['医疗功效', '夸大减脂'],
    content_formats: ['图文', '短视频'],
    deliverables_per_creator: 1,
    preferred_creator_tiers: ['micro', 'mid'],
    competitor_brands: ['蛋白星球', '谷物日记'],
    competitor_exclusion_days: 30,
    exclusivity_required_days: 14,
    risk_tolerance: 'low',
    brief_text:
      '围绕高蛋白早餐与透明配料建立可信赖的产品认知，并促进下单转化。',
  },
  {
    ...
    target_audience: {
      ...
      primary_age_band: '25_34',
      interest_tags: ['敏感肌', '成分护肤', '修护维稳'],
    },
    tone_tags: ['温和专业', '真实测评', '克制表达'],
    required_topics: ['敏感肌护理', '屏障修护', '成分解析'],
    forbidden_topics: ['医疗承诺', '绝对化功效'],
    content_formats: ['图文', '短视频'],
    deliverables_per_creator: 1,
    preferred_creator_tiers: ['micro', 'mid'],
    competitor_brands: ['润研', '净澈实验室'],
    competitor_exclusion_days: 30,
    exclusivity_required_days: 21,
    risk_tolerance: 'low',
    brief_text:
      '面向敏感肌人群传达温和修护价值，以真实体验与成分证据带动互动。',
  },
];
