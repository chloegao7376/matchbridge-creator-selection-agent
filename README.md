...
**[在线体验 MatchBridge 智选](https://matchbridge-creator-selection-agent.maple-owlet-9574.chatgpt.site)** · [查看 API 与算法文档](docs/)
...
历史有限达人使用冷启动兜底权重：内容相关性 40%、受众适配度 30%、流量质量 20%、数据质量 10%。
